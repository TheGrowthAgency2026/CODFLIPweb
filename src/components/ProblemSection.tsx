...
export default function ProblemSection() {
  ...
  return (
    <section id="about" className="py-24 px-6 md:px-12 lg:px-24 relative" style={{ background: '#0a0a0a' }}>
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <h2 style={{ fontFamily: 'var(--font-syne)', fontWeight: 800, fontSize: 'clamp(32px, 4vw, 52px)', color: '#fff', letterSpacing: '-1.5px', lineHeight: 1.1 }}>
              ...
              {stats.map((s) => (
                <div key={s.label} className="flex items-center gap-4 pl-4" style={{ borderLeft: '2px solid #10B981' }}>
                  <div>
                    ...
                    <div style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '14px', color: '#9CA3AF', marginTop: '2px' }}>
                      {s.label}
                    </div>
                  </div>
                </div>
          ...
          >
            <div className="rounded-2xl p-7" style={{ background: '#111111', border: '1px solid #1F2937' }}>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '13px', color: '#9CA3AF' }}>Monthly COD orders</label>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '13px', color: '#9CA3AF' }}>Your RTO rate</label>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '13px', color: '#9CA3AF' }}>Cost per return</label>
                ...
                {/* Result */}
                <div className="rounded-xl p-5 mt-2" style={{ background: '#0a0a0a', border: '1px solid #1F2937' }}>
                  <p style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '13px', color: '#9CA3AF', marginBottom: '8px' }}>
                  ...
                  <p style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '14px', color: '#9CA3AF', marginBottom: '10px' }}>
                    That&apos;s {formatINR(yearlyLoss)} / year
                  </p>
                  <p style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '14px', fontWeight: 500, color: '#fff' }}>
